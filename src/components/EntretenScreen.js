      ...
      <div className="px-lg-5">
        ...
        <div className="row py-5">
          <div className="col-lg-12 mx-auto">
            <div className="text-white p-5 shadow-sm rounded banner">
              <h1 className="display-4">Galleria de proyectos de entretenimiento</h1>
              <p className="lead">Aquí encontraras algunos proyectos personales o retos.</p>
            </div>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-xl-3 col-lg-4 col-md-6 mb-4">
            <div className="bg-white rounded shadow-sm"><a href="https://tellasecret.es"><img src="assets/img/portfolio/entretenimiento/tellasecret.png" alt="tellasecret" className="img-fluid card-img-top" /> </a>
              <div className="p-4">
                <h5> <a href="https://tellasecret.es" className="text-dark">Tell a secret</a></h5>
                <p className="small text-muted mb-0">Reto de enero 2021. App web donde poder confesar secretos de manera anónima</p>
                <p className="small text-muted mb-0 mt-3"><a href="https://tellasecret.es"> IR AL SITIO</a></p>
                <div className="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
                  ...
                  <div className="badge badge-info px-3 rounded-pill font-weight-normal">SASS</div>
                  <div className="badge badge-dark px-3 rounded-pill font-weight-normal">SQL</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="col-xl-3 col-lg-4 col-md-6 mb-4">
            <div className="bg-white rounded shadow-sm"><a href="https://github.com/Radega1993/CodeStructureMaker"><img src="assets/img/portfolio/entretenimiento/CodeStructureMaker.png" alt="code structure maker" className="img-fluid card-img-top"/> </a>
              <div className="p-4">
                <h5> <a href="https://github.com/Radega1993/CodeStructureMaker" className="text-dark">CodeStructureMaker</a></h5>
                <p className="small text-muted mb-0">Programa de terminal pensado para desarrolladores creando automaticamente la estructura inicial de un proyecto</p>
                <p className="small text-muted mb-0 mt-3"><a href="https://github.com/Radega1993/CodeStructureMaker"> IR AL SITIO</a></p>
                <div className="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
                  <p className="small mb-0"><span className="font-weight-bold">CLI</span></p>
                  <div className="badge badge-info px-3 rounded-pill font-weight-normal">PYTHON</div>
                </div>
              </div>
            </div>
          </div>
