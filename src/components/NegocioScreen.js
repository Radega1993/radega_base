      ...
      <div className="px-lg-5">
        ...
        <div className="row py-5">
          <div className="col-lg-12 mx-auto">
            <div className="text-white p-5 shadow-sm rounded banner">
              <h1 className="display-4">Galleria de proyectos de negocios</h1>
              <p className="lead">Aquí encontraras algunos proyectos para pequeñas empresas.</p>
            </div>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-xl-3 col-lg-4 col-md-6 mb-4">
            <div className="bg-white rounded shadow-sm"><a href="https://vupropertiesandservices.com"><img src="assets/img/portfolio/negocios/vu.png" alt="propiedades y servicios" className="img-fluid card-img-top" /> </a>
              <div className="p-4">
                <h5> <a href="https://vupropertiesandservices.com" className="text-dark">Vera Urrestarazu.</a></h5>
                <p className="small text-muted mb-0">Web para una empresa de mallorca que se encarga de asesoramiento legal en adquisición de bienes, reparaciones, restauraciones, reformas, de la jardinería, de los sistemas de riego, construcción de piscinas y su mantenimiento.</p>
                <p className="small text-muted mb-0 mt-3"><a href="https://vupropertiesandservices.com"> IR AL SITIO</a></p>
